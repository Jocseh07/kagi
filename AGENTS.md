...
**Read `DESIGN.md` before writing any UI.** It is the design contract; every color, size, spacing value, radius, and duration must trace to a token named there. It is gitignored and local-only — never commit it.
